...
<div class="content mt-3">
    <div class="card">
        <div class="card-header">
            <button class="btn btn-success btn-sm btn-show-add" data-toggle="modal" data-target="#compose"><i class="fa fa-plus"></i> Tambah Partner</button>
        </div>
        <div class="card-body">
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="largeModalLabel">Tambah Partner</h5>
            ...
            <div class="modal-body">
                <form action="" id="compose-form">
                    <div class="form-group">
                        <label>Foto</label>
                        <input type="file" name="userfile" class="dropify" data-default-file="" value="" />
                    </div>
                    <div class="form-group">
                        <label>Nama</label>
...
<script>
    $(".btn-show-add").on("click", function() {
        ...
        jQuery("#compose .modal-title").html("Tambah Partners");
        jQuery("#compose-form").attr("action", "<?= base_url("partners/insert"); ?>");
    });
    ...
    $("body").on("click", ".btn-edit", function() {
        ...
        jQuery("#compose .modal-title").html("Edit Partners");
        jQuery("#compose-form").attr("action", "<?= base_url(); ?>partners/update/" + id);
        jQuery("input[name=name]").val(name);
        jQuery("textarea[name=description]").val(description);
        jQuery(".dropify").attr('data-default-file', newurl);
