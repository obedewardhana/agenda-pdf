    ...
    <div class="card">
        <?php if ($dataAdmin->role == 'admin') { ?>
            <div class="card-header">
                <button class="btn btn-success btn-sm btn-show-add mr-2" data-toggle="modal" data-target="#compose"><i class="fa fa-plus-square"></i> Tambah Invitation</button>
                ...
                <div class="w-100 pt-3 pb-3 d-flex">
                    <a class="format-link small mr-4" target="_blank" href="<?= base_url("samples/invitation/invitation-sample-pdf.pdf"); ?>"><i class="fa fa-file mr-1"></i>Format Pdf</a>
                    <a class="format-link small mr-4" target="_blank" href="<?= base_url("samples/invitation/invitation-sample-word.docx"); ?>"><i class="fa fa-file mr-1"></i>Format Word</a>
                </div>
            </div>
...
<div class="modal" id="compose" tabindex="-1" phone="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" phone="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="largeModalLabel">Tambah Invitation</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal" id="composePDF" tabindex="-1" phone="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" phone="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="largeModalLabel">Upload PDF Invitation</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal" id="composeWORD" tabindex="-1" phone="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" phone="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="largeModalLabel">Upload Doc Invitation</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    $(".btn-show-add").on("click", function() {
        ...
        jQuery("#compose .modal-title").html("Tambah Invitation");
        jQuery("#composeForm").attr("action", "<?= base_url("invitation/insert"); ?>");
    ...
    $(".btn-show-pdf").on("click", function() {
        ...
        jQuery("input[name=document]").val("");
        jQuery("#composeFormPdf").attr("action", "<?= base_url("invitation/insert_bulk"); ?>");
    ...
    $(".btn-show-word").on("click", function() {
        ...
        jQuery("input[name=document]").val("");
        jQuery("#composeFormWord").attr("action", "<?= base_url("invitation/insert_bulk"); ?>");
    ...
    function deleteData(id) {
        jQuery.getJSON("<?= base_url(); ?>invitation/delete/" + id, function(data) {
    ...
    jQuery("body").on("click", ".btn-edit", function() {
        ...
        jQuery("#compose .modal-title").html("Edit Undangan");
        jQuery("#composeForm").attr("action", "<?= base_url(); ?>invitation/update/" + id);
